        ...
        <nav className="fixed w-full z-50 top-0 transition-all duration-300 glass shadow-sm">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-20 items-center">
                    <div className="flex">
                        <div className="flex-shrink-0 flex items-center gap-2 group cursor-pointer hover:scale-105 transition-transform duration-300">
                            <Image
                                src="/logo-new.png"
                                alt="Apni Vidya"
                                width={50}
                    ...
                    <div className="hidden md:flex md:items-center md:space-x-8">
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="bg-blue-600 text-white px-7 py-2.5 rounded-full font-bold hover:bg-blue-700 transition-all shadow-blue-200 shadow-lg active:scale-95 disabled:opacity-70 hover:shadow-blue-300 translate-y-0 hover:-translate-y-0.5"
                        >
                ...
                <div className="px-5 pt-4 pb-8 space-y-4 shadow-xl">
                    ...
                    <div className="pt-2">
                        <button
                            onClick={() => handlePayment(1, "All-in-One Skill Mastery")}
                            disabled={loading}
                            className="w-full bg-blue-600 text-white px-6 py-4 rounded-xl font-bold hover:bg-blue-700 transition-colors shadow-lg disabled:opacity-70 text-lg flex justify-center items-center gap-2"
                        >
