        ...
        <section id="courses" className="py-20 bg-[#e0efff] font-sans overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="max-w-[500px] mx-auto relative perspective-1000 group/poster">
                    ...
                    {/* Sparkling/Glow Effect Container */}
                    <div className="absolute -inset-1 bg-gradient-to-r from-yellow-300 via-yellow-100 to-yellow-300 rounded-[2.6rem] blur opacity-70 group-hover/poster:opacity-100 transition duration-1000 group-hover/poster:duration-200 animate-tilt"></div>
                    <div className="absolute -inset-[2px] bg-gradient-to-r from-blue-400 via-white to-blue-400 rounded-[2.6rem] opacity-50 blur-sm animate-pulse-slow"></div>
                        ...
                        <div className="bg-gradient-to-b from-[#2563eb] via-[#3b82f6] to-[#60a5fa] rounded-[2.2rem] border-t border-white/40 overflow-hidden relative shadow-inner">
                            ...
                            <div className="text-center pt-8 pb-10 relative">
                                ...
                                <div className="relative inline-block transform hover:scale-105 transition-transform duration-500 ease-out">
                                    <h2 className="text-[7.5rem] md:text-[9rem] font-black leading-none text-transparent bg-clip-text bg-gradient-to-b from-white via-blue-50 to-blue-200 drop-shadow-[0_10px_0px_rgba(30,58,138,0.3)] filter" style={{ WebkitTextStroke: '2px rgba(255,255,255,0.3)' }}>
                                        90<span className="text-[4rem] md:text-[5rem] align-super ml-1">%</span>
                                    </h2>
                                    <span className="absolute bottom-6 -right-4 text-white font-black text-3xl md:text-4xl drop-shadow-[0_4px_0_rgba(0,0,0,0.2)] rotate-[-12deg] tracking-wider bg-red-500 px-2 py-0.5 rounded-lg transform hover:rotate-0 transition-all duration-300">OFF</span>
                            ...
                            {/* Middle Ribbon - First 100 Students */}
                            <div className="relative w-[108%] -left-[4%] mb-6 group">
                                <div className="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white text-center py-2.5 shadow-lg relative z-20 flex justify-center items-center shadow-blue-900/50 border-y border-white/10">
                                    ...
                                    <p className="flex items-center justify-center gap-2 font-bold text-sm md:text-base italic tracking-wide relative z-10">
                                        ...
                                        Available only for the <span className="text-yellow-300 font-extrabold underline decoration-yellow-300/50 underline-offset-4 decoration-wavy">First 100 Students</span>
                                    </p>
                                </div>
                            ...
                            <div className="bg-gradient-to-b from-white to-blue-50 mx-4 mb-4 rounded-xl p-5 shadow-[inset_0_2px_4px_rgba(0,0,0,0.1)] text-slate-800 relative z-10 border border-white">
                                ...
                                {/* Previous Content: Specific Courses */}
                                ...
                                <div className="grid grid-cols-2 gap-2.5">
                                    {features.map((feature, i) => (
                                        <div key={i} className="flex flex-col items-center text-center p-2.5 bg-white rounded-lg border border-blue-50 shadow-sm hover:shadow-md transition-all hover:border-blue-200 hover:-translate-y-0.5">
                                            <div className="h-7 w-7 mb-1.5 opacity-90 scale-110">
                                                <DotLottieReact
                            ...
                            {/* Bottom Ribbon - Limited Seats */}
                            <div className="relative mx-8 mb-6 mt-4">
                                <div className="bg-gradient-to-r from-red-600 to-red-500 text-white text-center py-2 clip-path-ribbon relative shadow-lg ring-1 ring-red-400/50 animate-pulse-slow">
                                    <p className="flex items-center justify-center gap-2 font-bold text-xs md:text-sm uppercase tracking-wider text-shadow-sm">
                                        <Zap className="w-4 h-4 fill-yellow-300 text-yellow-300" />
                                        Limited Seats <span className="opacity-50">|</span> Limited Time
                            ...
                            <div className="px-5 pb-8 relative z-20">
                                <button
                                    onClick={() => handlePayment(149, "All-in-One Skill Mastery")}
                                    disabled={loading}
                                ...
                                >
                                    ...
                                    <div className="bg-gradient-to-b from-white to-blue-50 rounded-full py-3 px-4 flex flex-col items-center justify-center border-2 border-blue-200 relative z-10 group-hover:border-blue-300 transition-colors">
                                        <span className="text-xl md:text-2xl font-black uppercase tracking-wide text-transparent bg-clip-text bg-gradient-to-br from-blue-800 to-blue-600 drop-shadow-sm flex items-center gap-2">
                                            Enroll Now <Users className="w-5 h-5 text-blue-600" />
                                        </span>
                                ...
                                <div className="text-center mt-5 flex justify-center items-center gap-3 text-blue-100/90 font-medium">
                                    <div className="px-3 py-1 bg-blue-900/40 rounded-full border border-blue-400/30 backdrop-blur-md shadow-lg">
                                        <span className="text-xs uppercase mr-2 tracking-wider opacity-90 text-blue-200">Pay Only</span>
                                        <span className="text-2xl font-bold text-white shadow-black drop-shadow-md">$149</span>
                                    </div>
                                    <span className="text-sm opacity-60 line-through decoration-red-400 decoration-2 text-blue-200 font-semibold">$1600</span>
                                </div>
                            </div>
